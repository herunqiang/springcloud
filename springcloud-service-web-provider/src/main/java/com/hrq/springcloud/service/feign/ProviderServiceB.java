 ...
 **/
@FeignClient(value = SystemConstant.SPRINGCLOUD_PROVIDER_SERVICE_NAME_B, fallback = ProviderClientFallbackB.class)
public interface ProviderServiceB {

    @RequestMapping(value = "test/getName", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "test/insertUser")
